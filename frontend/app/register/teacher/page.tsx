...
export default function RegisterTeacher() {
    ...
    async function onSubmit(data: FormSchemaType) {
        try {
            await api.post("/auth/teacher/register", data);
        ...
        <div className="min-h-[92vh] flex items-center justify-center p-4 relative">
            ...
            <Card className="w-full max-w-md shadow-lg">
                <CardContent className="p-6 space-y-6">
                    <h1 className="text-2xl font-bold text-center">Cadastrar como Professor</h1>
                    ...
                    <p className="text-center text-sm mt-4">
                        Já tem uma conta?{" "}
                        <Link href="/login/teacher" className="text-blue-600 dark:text-blue-400 hover:underline">
                            Entrar
                        </Link>
                    </p>
                </CardContent>
